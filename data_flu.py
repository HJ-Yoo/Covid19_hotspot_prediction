...
def data_loader_flu(args):
    ...
    print('== data import ==')
    # Dataset import -------------------------------------------------------------------------------------
    node_seoul_user_17_np = np.load('./data/raw_data/flu/seoul_sgg_sty_2017_2018.npy', allow_pickle=True)
    node_seoul_user_18_np = np.load('./data/raw_data/flu/seoul_sgg_sty_2018_2019.npy', allow_pickle=True) 
    node_seoul_user_19_np = np.load('./data/raw_data/flu/seoul_sgg_sty_2019_2020.npy', allow_pickle=True)
    ...
    edge_seoul_user_17 = np.load('./data/raw_data/flu/seoul_sgg_mv_2017_2018.npy', allow_pickle=True)
    edge_seoul_user_18 = np.load('./data/raw_data/flu/seoul_sgg_mv_2018_2019.npy', allow_pickle=True)
    edge_seoul_user_19 = np.load('./data/raw_data/flu/seoul_sgg_mv_2019_2020.npy', allow_pickle=True) 
    edge_seoul_user = np.concatenate((edge_seoul_user_17, edge_seoul_user_18, edge_seoul_user_19))
    
    seoul_flu = torch.from_numpy(np.load('./data/raw_data/flu/flu_seoul.npy', allow_pickle=True))
    ...
    if not os.path.exists(os.path.join(args.data_path + 'train_'+ data_filename)):
        ...
        weather_17 = pd.read_csv('./data/raw_data/flu/2017_2018_weather.csv', sep=',', encoding='iso-8859-1')
        weather_18 = pd.read_csv('./data/raw_data/flu/2018_2019_weather.csv', sep=',', encoding='iso-8859-1')
        weather_19 = pd.read_csv('./data/raw_data/flu/2019_2020_weather.csv', sep=',', encoding='iso-8859-1')
