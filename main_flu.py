from models_flu import GC_TG_LSTM
...
def parse_args():
    ...
    # data hyperparameter
    parser.add_argument('--train_days', default=295, type=int, help='# of epochse')
    parser.add_argument('--delay_days', default=0, type=int, help='# of epochse')
    parser.add_argument('--test_days', default=152, type=int, help='# of epochse')
    
    # model hyperparameters
    parser.add_argument('--batch_size', default=4, type=int, help='# of epochse')
    ...
    parser.add_argument('--num_dong', default=25, type=int, help='# of epochse')
    ...
    parser.add_argument('--lstm_hidden_size', default=100, type=int, help='# of epochse')
    parser.add_argument('--lstm_sequence_length', default=7, type=int, help='# of epochse')
    parser.add_argument('--graph_conv_feature_dim_user', default=20, type=int, help='# of epochse')
...
#                     loss = user_mse + infect_mse
            ...
            filename = os.path.join('flu_{}_{}_lr{}_d{}-{}-{}_s{}_cat{}_temp{}_all{}_lstm-h-dim{}_lstm-in-dim{}_g-user-dim{}_deep{}'.format(
                                                                                                                args.task,
                                                                                                                args.loss,
                                                                                                                args.learning_rate, 
                                                                                                                args.train_days,
